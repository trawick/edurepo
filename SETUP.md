...
TBD...  (Using Django's `manage.py` to dump tables for the `resources` and `teachers` apps in fixture format should be sufficient, but a general helper script that can be used from cron should be provided.)
